...
public class Fournisseur {
    ...
    private long nombre_occurence_entrees_fournisseur = 0;

    public long getNombre_occurence_entrees_fournisseur() {return nombre_occurence_entrees_fournisseur;}
    public void setNombre_occurence_entrees_fournisseur(long occ) {this.nombre_occurence_entrees_fournisseur = occ;}
